...
class TestConfigManager:
    ...
    def test_env_file_exists(self, mock_exists, mock_load_dotenv) -> None:  # noqa: ANN001
    ...
    def test_env_file_not_exists(self, mock_exists, mock_load_dotenv) -> None:  # noqa: ANN001
